...
class PaymentRouter extends PaymentController {
  constructor() {
    ...
    this.route.delete(
      "/cancel-subscription/:apartment_id/:subscription_id",
      this.deleteSubscription.bind(this),
    );
    this.route.get(
      "/get-subscription-details/:apartment_id",
      this.getSubscriptionDetails.bind(this),
    );
    this.route.get(
      "/get-subscription-details",
      admin_verify,
      this.getAllSubscriptions.bind(this),
    );
  }
}
